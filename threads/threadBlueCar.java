...
public class threadBlueCar extends Thread {
  ...
  public void run() {
    while (true) {
      ...
      // COLISAO 17 (VERIFICANDO SEMAFORO)
      ...
      // LIBERANDO SEMAFORO DA COLISAO 69
      controller.colision69.release();
      // COLISAO 70 (VERIFICANDO SEMAFORO)
      controller.semaphoreControl(70);
