...
public class threadPurpleCar extends Thread {
    ...
    public void run() {
        while (true) {
            ...
            // PERCORRENDO RUA 3
            controller.moveX(3, 7, 1);
            // PERCORRENDO RUA 4
            controller.moveX(4, 7, 1);
            // PERCORRENDO RUA 10
            controller.rotate(7, 180);
            controller.moveY(10, 7, 1);
            // PERCORRENDO RUA 21
            controller.moveY(21, 7, 1);
            // PERCORRENDO RUA 27
            controller.rotate(7, 90);
            controller.moveX(27, 7, 1);
